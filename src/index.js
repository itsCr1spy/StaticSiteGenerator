...
var eta = new eta_1.Eta(etaOptions);
// Configure Express to use the Eta template engine
exports.app.engine("eta", function () {
    eta.render;
});
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 1:
                                    ...
                                    if (data && !uniqueData.some(function (item) { return item.activity === data.activity; })) {
                ...
                case 3:
                    ...
                    exports.app.get("/:pageId", function (req, res) {
